...
public class equals 
{
	public static void main(String[] args) 
	{
		...
		String s5="Khushabu";
		String s6= new String("Khushabu");
		System.out.println(s5.equals(s6));//it sees the content of the string
		System.out.println(s5==s6);//it sees the reference variable of the string
